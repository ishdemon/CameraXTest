...
class CameraPreviewTest : LifecycleOwner, ImageReader.OnImageAvailableListener, Consumer<Result> {
    ...
    fun checkPreviewUseCase() {
        ...
        preview.setSurfaceProvider(executor!!, Preview.SurfaceProvider { request: SurfaceRequest ->
